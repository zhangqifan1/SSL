package com.v.zqfstore.Activities;
        ...
        if (aMapLocation != null) {
            if (aMapLocation.getErrorCode() == 0) {
                ...
                if (isFirstLoc) {
                    ...
                    buffer2.append(aMapLocation.getCity());
                    MessageBean messageBean = new MessageBean();
                    messageBean.setLocationInfo(buffer.toString());
                    messageBean.setCityName(buffer2.toString());
